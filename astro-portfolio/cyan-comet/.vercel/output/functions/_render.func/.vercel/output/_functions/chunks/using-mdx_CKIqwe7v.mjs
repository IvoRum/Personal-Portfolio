import { _ as __astro_tag_component__, F as Fragment, g as createVNode } from './astro/server_CzNe6w_R.mjs';
import { $ as $$Image } from './_astro_assets_CyzqKUXR.mjs';
import { $ as $$HeaderLink } from './HeaderLink_DOQdGwzP.mjs';
import 'clsx';
...
const url = "src/content/blog_example/using-mdx.mdx";
const file = "C:/tomcats/Personal-Portfolio/astro-portfolio/cyan-comet/src/content/blog_example/using-mdx.mdx";
...
Content.moduleId = "C:/tomcats/Personal-Portfolio/astro-portfolio/cyan-comet/src/content/blog_example/using-mdx.mdx";
